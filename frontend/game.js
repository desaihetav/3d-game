class Game {
  ...
  init() {
    ...
    const light = new THREE.DirectionalLight(0xaaaaaa, 0.4);
    ...
    loader.load(`${this.assetsPath}fbx/people/${model}.fbx`, function (object) {
      ...
      textureLoader.load(
        `${game.assetsPath}images/SimplePeople_${name}_${colour}.png`,
        function (texture) {
          object.traverse(function (child) {
            if (child.isMesh) {
  ...
  loadEnvironment(loader) {
    ...
    loader.load(`${this.assetsPath}fbx/town.fbx`, function (object) {
      // loader.load(`${this.assetsPath}invact.fbx`, function (object) {
  ...
  playerControl(forward, turn) {
    console.log("playerControl called");
    turn = -turn;
